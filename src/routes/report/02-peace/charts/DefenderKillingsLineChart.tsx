...
function useData() {
  return useQuery({
    queryKey: ['defender-killings-by-year'],
    queryFn: () =>
      fetchAndParseJSON('/data/report/02-peace/16-10-1/defender-killings-by-year.json'),
  });
}
...
export default function DefenderKillingsLineChart() {
  ...
  return (
    <SimpleLineChart
      data={transformDataForGraph(data, 'lineChart', [
