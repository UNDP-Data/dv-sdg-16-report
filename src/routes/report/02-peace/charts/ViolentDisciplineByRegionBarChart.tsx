...
function useData() {
  return useQuery({
    queryKey: ['violent-discipline-by-region'],
    queryFn: () =>
      fetchAndParseJSON('/data/report/02-peace/16-2-1-16-2-3/violent-discipline-by-region.json'),
  });
}
  ...
  return (
    <SimpleBarGraph
      data={transformDataForGraph(data, 'barChart', [
        ...
        { columnId: 'share', chartConfigId: 'size' },
      ])}
