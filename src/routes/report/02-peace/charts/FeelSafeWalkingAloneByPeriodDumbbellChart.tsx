...
function useData() {
  return useQuery({
    queryKey: ['feel-safe-walking-alone-by-region-period'],
    queryFn: () =>
      fetchAndParseJSON(
        '/data/report/02-peace/16-1-4/feel-safe-walking-alone-by-region-period.json',
      ),
  });
}
