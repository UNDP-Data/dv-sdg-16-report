...
interface DataType {
  label: string;
  groupType: 'incomeGroup' | 'region' | 'global';
  publicService: number;
  judiciary: number;
}
function useData() {
  return useQuery({
    queryKey: ['representation-by-region-and-income-group'],
    queryFn: () =>
      fetchAndParseJSON(
        '/data/report/04-inclusion/16-7-1-b-c/representation-by-region-and-income-group.json',
      ) as Promise<DataType[]>,
  });
}
      ...
      >
        ...
        <div>
          ...
          <RadioGroup
            ...
            color='blue'
          >
            <RadioGroupItem value='publicService' label='Public service' />
