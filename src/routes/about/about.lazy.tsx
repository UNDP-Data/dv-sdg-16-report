...
import { H1, H5, P } from '@undp/design-system-react/Typography';
...
export function About() {
  return (
    <>
      ...
      <section className='px-6 pt-16 pb-16 md:px-12 md:pt-20 md:pb-24'>
        <SectionContainer className='flex flex-col'>
          <div className='flex flex-col gap-y-4 border-stroke-sm border-t py-10 first:border-t-0 first:pt-0 last:pb-0 md:flex-row md:gap-x-10'>
            <P
              marginBottom='none'
              size='lg'
              weight='semibold'
              className='shrink-0 font-heading text-foreground md:w-44 lg:w-52'
            >
              About the report
            </P>
                ...
                >
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <H5
                      ...
                      className='font-heading text-foreground text-lg! leading-[130%]'
                    >
                      Global Progress Report on Sustainable Development Goal 16: Indicators on
                ...
                <div className='flex gap-6 border border-stroke-sm p-6'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <H5
                      ...
                      className='font-heading text-foreground text-lg! leading-[130%]'
                    >
                      Global Progress Report on Sustainable Development Goal 16 — Latin America and
                      the Caribbean: Indicators on Peaceful, Just and Inclusive Societies
                    </H5>
          ...
          <div className='flex flex-col gap-y-4 border-stroke-sm border-t py-10 first:border-t-0 first:pt-0 last:pb-0 md:flex-row md:gap-x-10'>
            ...
            <div className='flex max-w-180 flex-col'>
              <P marginBottom='xs' size='lg'>
                This report was prepared jointly by the Human Rights Statistics Unit of the
              ...
              <P marginBottom='xs' size='lg'>
                ...
                Sustainable Development Office (FSDO); the United Nations Office for Disarmament
                Affairs (UNODA); the United Nations Trade and Development (UNCTAD); and the World
                Health Organization (WHO). The authors further acknowledge the United Nations
                Statistics Division (UNSD) of the United Nations Department of Economic and Social
                Affairs (UN DESA) for its leadership in compiling and disseminating global SDG
                indicators data.
              </P>
              <P marginBottom='xs' size='lg'>
                The agencies wish to express their sincere appreciation to national institutions
                that contribute to the production and validation of the data underpinning the
                indicators, including especially national statistical offices but also National
                Human Rights Institutions, ministries of justice, courts, prosecution services,
                police and law enforcement authorities, prison and correctional administrations,
                anti-corruption bodies, electoral management authorities, civil registration
                agencies, parliamentary institutions, and other public sector entities. Their
                continued commitment to producing, sharing, and improving high-quality data is
                essential for monitoring progress towards peaceful, just, and inclusive societies.
                Particular gratitude is extended also to the many United Nations Country Teams,
                agencies’ country and regional offices that contribute to the production and
                validation of the data included in this report.
              </P>
            </div>
          </div>
          <div className='flex flex-col gap-y-4 border-stroke-sm border-t py-10 first:border-t-0 first:pt-0 last:pb-0 md:flex-row md:gap-x-10'>
            ...
            <div className='grid grow gap-6 sm:grid-cols-2'>
              <div className='flex flex-col gap-2'>
