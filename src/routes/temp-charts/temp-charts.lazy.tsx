...
import HomicideRateBySexLineChart from '@/routes/report/02-peace/charts/HomicideRateBySexLineChart';
import IntimatePartnerHomicideByRegionSexBarChart from '@/routes/report/02-peace/charts/IntimatePartnerHomicideByRegionSexBarChart';
import NonLethalViolenceByTypeSexStripChart from '@/routes/report/02-peace/charts/NonLethalViolenceByTypeSexStripChart';
import SexualViolenceInChildhoodUnitChart from '@/routes/report/02-peace/charts/SexualViolenceInChildhoodUnitChart';
import TraffickingByExploitationFormDonutChart from '@/routes/report/02-peace/charts/TraffickingByExploitationFormDonutChart';
import TraffickingVictimsBySexAgeUnitChart from '@/routes/report/02-peace/charts/TraffickingVictimsBySexAgeUnitChart';
import ViolentDisciplineByRegionBarChart from '@/routes/report/02-peace/charts/ViolentDisciplineByRegionBarChart';
...
import BudgetDeviationByIncomeGroupLineChart from '@/routes/report/04-inclusion/charts/BudgetDeviationByIncomeGroupLineChart';
import DiscriminationRatesByGroupBarChart from '@/routes/report/04-inclusion/charts/DiscriminationRatesByGroupBarChart';
import HealthcareSatisfactionByRegionBarChart from '@/routes/report/04-inclusion/charts/HealthcareSatisfactionByRegionBarChart';
import ParliamentaryLeadershipByCategoryBarChart from '@/routes/report/04-inclusion/charts/ParliamentaryLeadershipByCategoryBarChart';
import PoliticalEfficacyByRegionBarChart from '@/routes/report/04-inclusion/charts/PoliticalEfficacyByRegionBarChart';
import RepresentationByInstitutionalLevelBarChart from '@/routes/report/04-inclusion/charts/RepresentationByInstitutionalLevelBarChart';
import GapToParityBarChart from '@/routes/report/04-inclusion/charts/RepresentationByRegionAndIncomeGroupsBarChart';
import SatisfactionWithPublicServicesStripChart from '@/routes/report/04-inclusion/charts/SatisfactionWithPublicServicesStripChart';
import VoteSharesByInstitutionDumbbellChart from '@/routes/report/04-inclusion/charts/VoteSharesByInstitutionDumbbellChart';
