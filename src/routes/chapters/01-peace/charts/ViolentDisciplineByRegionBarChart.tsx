...
export default function ViolentDisciplineByRegionBarChart() {
  return (
    <SimpleBarGraph
      ...
      sources={[{ source: 'TBA' }]}
      ariaLabel='Horizontal bar chart showing the share of children experiencing violent discipline in the past month, by region, with the world figure shown first.'
    />
  );
}
