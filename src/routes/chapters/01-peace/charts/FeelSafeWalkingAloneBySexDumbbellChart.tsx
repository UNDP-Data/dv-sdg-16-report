    ...
    <DumbbellChart
      ...
      graphTitle={
        <P marginBottom='none' className='font-heading font-semibold leading-sm'>
          ...
          live in, by region and sex (2021–2025)
        </P>
      }
      sources={[{ source: 'UNODC' }]}
      footNote={
        <ChartNote content='Estimates are based on responses to the United Nations Survey of Crime Trends and Operations of Criminal Justice Systems, Multiple Indicator Cluster Surveys, and the Gallup World Poll. Regional aggregates refer to 3-year averages weighted by countries’ population size. Most surveys include the qualifications “after dark” or “at night” in the question wording. Averages for Oceania were removed, as only data for one country was available.' />
      }
