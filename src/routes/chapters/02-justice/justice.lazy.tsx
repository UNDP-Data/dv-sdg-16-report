          ...
          <>
            <TextContainer>
              <P marginBottom='none' size='lg'>
                ...
                fundamental to protecting rights, preventing conflicts from escalating, and
          ...
          <>
            <TextContainer>
              <P marginBottom='none' size='lg'>
                ...
                Their impacts are particularly severe in countries facing political instability,
                weak institutions and state capture. Both outflows and inflows can deplete a
                country's resources, instead fuelling corruption, organized crime and terrorism.
              </P>
              <Highlight
                color='secondary'
        ...
        content: (
          ...
          patterns and reduce illicit arms flows.'
              ...
              <P marginBottom='none' size='lg'>
                ...
                manufacturing methods, including counterfeit production, artisanal manufacture as
                well as the modification of non-lethal/less-lethal weapons (e.g. gas and blank
                firing, alarm or signal weapons) into firearms. This is often accompanied by the
          ...
          <>
            <TextContainer>
              <P marginBottom='none' size='lg'>
                ...
                services and weaken confidence that laws are applied fairly. In half of the 139
                countries and territories with available data, at least 17 per cent of people who
                had contact with a public official during the previous 12 months either paid a bribe
                or were asked to pay one.
              </P>
              <P marginBottom='none' size='lg'>
      ...
      },
      {
        ...
        content: (
          <>
            <TextContainer>
              <P marginBottom='none' size='lg'>
                Corruption can increase the cost of doing business, distort competition and
                discourage investment. Evidence suggests that bribery is generally less common among
                businesses than among individuals interacting with public officials. However,
                concerns about legal or reputational consequences may lead to underreporting. As a
                result, estimates should be interpreted as a minimum estimate of the true extent of
                business bribery.
              </P>
              <P marginBottom='none' size='lg'>
              ...
              <P marginBottom='none' size='lg'>
                These differences suggest that businesses operating in lower-income settings are
                more likely to encounter bribery when dealing with public officials. Countries
                reporting higher levels of bribery affecting businesses also tend to{' '}
                <InfoTooltip
                  ...
                  color='secondary'
                />
                . This suggests that corruption affecting businesses and households often reflects
                the same underlying governance and accountability challenges.
              </P>
              <Highlight color='secondary' content='Business bribery has declined over time' />
              <P marginBottom='none' size='lg'>
                Available trend data suggest a moderate decline in business bribery across all
                income groups between 2010–2016 and 2017–2024. The largest improvements were
                observed in low-income countries, where the median prevalence fell from 21.0 per
                cent to 12.3 per cent, and in lower-middle-income countries, where it declined from
                25.6 per cent to 16.8 per cent. Although these trends point to gradual progress and
                that efforts towards transparent governance and reducing corruption are paying off
                globally, bribery continues to affect businesses in many countries.
              </P>
              <PlaceholderBlock label='Figure' />
            </TextContainer>
            <WaveDivider src='/imgs/dividers/justice-02.webp' align='right' />
          ...
          <>
            <TextContainer>
              <P marginBottom='none' size='lg'>
                ...
                compliant with the Paris Principles, the internationally agreed standards that
                define their independence, mandate, effectiveness, and functioning. This represents
                46 per cent of UN Member States and observers and covers 55 per cent of the world's
                population. A further 26 countries had institutions with partial compliance.
              </P>
              <P marginBottom='none' size='lg'>
              ...
              <P marginBottom='none' size='lg'>
                ...
                institutions function in practice. Important aspects such as operational
                independence, resources, accessibility, responsiveness, and impact on human rights
                outcomes remain difficult to measure systematically and across different countries'
                contexts. Accelerating progress will require not only establishing National Human
                Rights Institutions where they do not yet exist but also strengthening the evidence
                base on institutional performance. In this way, one can ensure that full compliance
                translates into meaningful protection of human rights.
              </P>
            </TextContainer>
            <WaveDivider src='/imgs/dividers/justice-03.webp' />
          </>
