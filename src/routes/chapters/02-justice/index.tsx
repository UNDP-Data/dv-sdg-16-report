      ...
      content: (
        <>
          <P marginBottom='none' size='lg'>
            ...
            in international human rights law. Yet, in 2024 an estimated 11.6 million people were
            held in detention worldwide, corresponding to a prison population rate of 143 prisoners
          ...
          <P marginBottom='none' size='lg'>
            ...
            decade, at around 30 per cent, equivalent to approximately 3.6 million people.
          </P>
          <P
            marginBottom='none'
            size='lg'
          ...
          >
            ...
            majority of the global prison population, women account for a higher share of
      ...
      content: (
        <>
          <P marginBottom='none' size='lg'>
            ...
            that could otherwise be invested in public services, institutions and development. Their
      ...
      content: (
        <>
          ...
          <P marginBottom='none' size='lg'>
            ...
            as the modification of non-lethal/less-lethal weapons (e.g. gas and blank firing, alarm
            or signal weapons) into firearms. This is often accompanied by the alteration and
            falsification of original markings. In conflict settings, the diversion of weapons
      ...
      content: (
        <>
          ...
          <P marginBottom='none' size='lg'>
            ...
            prevalence was recorded in Sub-Saharan Africa with 24 per cent and Central and Southern
            Asia with 22.5 per cent. In contrast, Europe and Northern America recorded the lowest
            median prevalence with only 9 per cent.
          </P>
          <Highlight
            color='secondary'
          ...
          />
          <P marginBottom='none' size='lg'>
            Bribery was most prevalent in low-income countries, where the median prevalence reached
            27 per cent, compared with 9 per cent in high-income countries. Nevertheless,
      ...
      content: (
        <>
          <P marginBottom='none' size='lg'>
            ...
            than among individuals interacting with public officials. However, concerns about legal
            or reputational consequences may lead to underreporting. As a result, estimates should
            be interpreted as a minimum estimate of the true extent of business bribery.
          </P>
          <P marginBottom='none' size='lg'>
            The prevalence of bribery among businesses varies considerably across regions and income
            groups. Sub-Saharan Africa and Eastern and South-Eastern Asia recorded the highest
            median levels of business bribery, while Europe and Northern America recorded the
            lowest. Businesses operating in low-income countries reported the highest median
          ...
          <P marginBottom='none' size='lg'>
            ...
            transparent governance and reducing corruption are paying off globally, bribery
      ...
      content: (
        <>
          <P marginBottom='none' size='lg'>
            ...
            Member States and observers and covers 55 per cent of the world's population. A further
            26 countries had institutions with partial compliance.
          </P>
          <P marginBottom='none' size='lg'>
          ...
          />
          <P marginBottom='none' size='lg'>
            Despite steady long-term gains, progress remains too slow to achieve universal coverage
            of fully compliant institutions by 2030. Since 2015, the number of fully compliant
            institutions has increased by an average of only two countries per year. Additionally,
            accreditation status alone does not fully capture how effectively institutions function
            in practice. Important aspects such as operational independence, resources,
            accessibility, responsiveness, and impact on human rights outcomes remain difficult to
            measure systematically and across different countries' contexts. Accelerating progress
            will require not only establishing National Human Rights Institutions where they do not
            yet exist but also strengthening the evidence base on institutional performance. In this
